...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lm92/b;->a:Landroid/content/Context;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lm92/b;->b:Ljava/util/HashMap;
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lm92/b;->a:Landroid/content/Context;

    invoke-static {v0}, Lcom/bumptech/glide/c;->m(Landroid/content/Context;)Lcom/bumptech/glide/s;

    move-result-object v0

    iget-object v1, p0, Lm92/b;->b:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lm92/b;->b:Ljava/util/HashMap;
...
.method public final b(Ljava/lang/String;Lru/yandex/yandexmaps/multiplatform/location/sharing/pins/android/api/f;)V
    .locals 2

    new-instance v0, Lm92/c;

    invoke-direct {v0, p2}, Lm92/c;-><init>(Lru/yandex/yandexmaps/multiplatform/location/sharing/pins/android/api/f;)V

    iget-object p2, p0, Lm92/b;->b:Ljava/util/HashMap;

    invoke-interface {p2, p1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p2, p0, Lm92/b;->a:Landroid/content/Context;
