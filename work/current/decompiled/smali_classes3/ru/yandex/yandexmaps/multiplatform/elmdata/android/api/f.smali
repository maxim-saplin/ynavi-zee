.class public final synthetic Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;
...
.method public synthetic constructor <init>(I)V
    ...
    iput p1, p0, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;->b:I
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v2, p0, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;->b:I
    ...
    sget-object v3, Ls91/b;->i:Ls91/a;
    ...
    invoke-static {v4, v1, v3}, Ls91/a;->b(Ljava/lang/String;IF)Ls91/b;

    move-result-object v1

    sget-object v3, Ls91/b;->n:Ls91/b;

    filled-new-array {v0, v2, v1, v3}, [Ls91/b;
    ...
    sget-object v1, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/ElmDataRootController;->m:[Lc41/m;

    new-instance v1, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;

    const/4 v2, 0x2

    invoke-direct {v1, v2}, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;-><init>(I)V

    invoke-virtual {p1, v1}, Lru/yandex/yandexmaps/uikit/shutter/g;->i(Lkotlin/jvm/functions/Function1;)V

    new-instance v1, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;

    invoke-direct {v1, v0}, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;-><init>(I)V
    ...
    new-instance v0, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;

    const/4 v1, 0x1

    invoke-direct {v0, v1}, Lru/yandex/yandexmaps/multiplatform/elmdata/android/api/f;-><init>(I)V
