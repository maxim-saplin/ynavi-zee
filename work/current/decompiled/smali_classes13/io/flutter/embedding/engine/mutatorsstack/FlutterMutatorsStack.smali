...
.field private mutators:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Lio/flutter/embedding/engine/mutatorsstack/c;",
            ">;"
        }
    .end annotation
.end field
...
.method public pushClipRRect(IIII[F)V
    ...
    new-instance p1, Lio/flutter/embedding/engine/mutatorsstack/c;

    invoke-direct {p1, p0, v0, p5}, Lio/flutter/embedding/engine/mutatorsstack/c;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Rect;[F)V
...
.method public pushClipRect(IIII)V
    ...
    invoke-direct {p1, p0, v0}, Lio/flutter/embedding/engine/mutatorsstack/c;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Rect;)V
...
.method public pushTransform([F)V
    ...
    invoke-direct {p1, p0, v0}, Lio/flutter/embedding/engine/mutatorsstack/c;-><init>(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/mutatorsstack/c;->a()Landroid/graphics/Matrix;
