...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean v0, Lio/reactivex/rxjava3/internal/schedulers/m;->b:Z
    ...
    sget-object v1, Lio/reactivex/rxjava3/internal/schedulers/m;->f:Ljava/util/Map;

    invoke-interface {v1, v0, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;
    ...
    iget-boolean v0, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->c:Z
...
.method public final b(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/rxjava3/internal/schedulers/k;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->c:Z

    iget-object v0, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/rxjava3/disposables/c;)Lio/reactivex/rxjava3/internal/schedulers/ScheduledRunnable;
    .locals 3
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;
    .locals 3
...
.method public final g(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/b;
    .locals 8
    ...
    iget-object p5, p0, Lio/reactivex/rxjava3/internal/schedulers/k;->b:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {p4, p1, p5}, Lio/reactivex/rxjava3/internal/schedulers/e;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lio/reactivex/rxjava3/internal/schedulers/e;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
