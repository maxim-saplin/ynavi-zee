...
.method private parseHeaders([Ljava/lang/String;Z)Lokhttp3/u0;
    .locals 7
    ...
    invoke-static {v4}, Lokhttp3/b1;->a(Ljava/lang/String;)Lokhttp3/c1;

    move-result-object v5

    iput-object v5, p0, Lretrofit2/RequestFactory$Builder;->contentType:Lokhttp3/c1;
    :try_end_0
    ...
    sget-object v5, Lokhttp3/u0;->c:Lokhttp3/t0;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v6}, Lokhttp3/t0;->a(Ljava/lang/String;)V

    invoke-virtual {v0, v6, v4}, Lokhttp3/s0;->c(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v0, v6, v4}, Lokhttp3/s0;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method private parseMethodAnnotation(Ljava/lang/annotation/Annotation;)V
    ...
    invoke-direct {p0, v0, p1}, Lretrofit2/RequestFactory$Builder;->parseHeaders([Ljava/lang/String;Z)Lokhttp3/u0;

    move-result-object p1

    iput-object p1, p0, Lretrofit2/RequestFactory$Builder;->headers:Lokhttp3/u0;
...
.method private parseParameterAnnotation(ILjava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljava/lang/annotation/Annotation;)Lretrofit2/ParameterHandler;
    ...
    invoke-static {v3, v0, v7}, Lf;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p4}, Lokhttp3/t0;->d([Ljava/lang/String;)Lokhttp3/u0;
    ...
    invoke-direct {p3, v0, p1, p4, p2}, Lretrofit2/ParameterHandler$Part;-><init>(Ljava/lang/reflect/Method;ILokhttp3/u0;Lretrofit2/Converter;)V
    ...
    invoke-static {p2, p3, v0}, Landroidx/camera/camera2/internal/i3;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
