.class final Lru/yandex/video/data/PlaybackParameters$copy$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/yandex/video/data/PlaybackParameters;->copy(Ljava/lang/Long;ZLjava/util/Map;Lru/yandex/video/data/AdParameters;)Lru/yandex/video/data/PlaybackParameters;
.end annotation
...
.method public constructor <init>(Ljava/lang/Long;Ljava/util/Map;Lru/yandex/video/data/AdParameters;Lru/yandex/video/data/PlaybackParameters;)V
    ...
    iput-object p1, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$startPosition:Ljava/lang/Long;

    iput-object p2, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$additionalParameters:Ljava/util/Map;

    iput-object p3, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$adParameters:Lru/yandex/video/data/AdParameters;

    iput-object p4, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->this$0:Lru/yandex/video/data/PlaybackParameters;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$startPosition:Ljava/lang/Long;

    invoke-virtual {p1, v0}, Lru/yandex/video/data/d;->i(Ljava/lang/Long;)V

    iget-object v0, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$additionalParameters:Ljava/util/Map;

    invoke-virtual {p1, v0}, Lru/yandex/video/data/d;->c(Ljava/util/Map;)V

    iget-object v0, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->$adParameters:Lru/yandex/video/data/AdParameters;

    invoke-virtual {p1, v0}, Lru/yandex/video/data/d;->b(Lru/yandex/video/data/AdParameters;)V

    iget-object v0, p0, Lru/yandex/video/data/PlaybackParameters$copy$4;->this$0:Lru/yandex/video/data/PlaybackParameters;
