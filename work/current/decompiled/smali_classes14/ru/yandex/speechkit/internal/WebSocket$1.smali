.class Lru/yandex/speechkit/internal/WebSocket$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/yandex/speechkit/internal/WebSocket;->open()V
.end annotation
...
# direct methods
.method public constructor <init>(Lru/yandex/speechkit/internal/WebSocket;)V
    .locals 1

    iput-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;
    ...
    iput-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->pongTimer:Ljava/util/Timer;

    return-void
.end method

.method public static bridge synthetic a(Lru/yandex/speechkit/internal/WebSocket$1;)V
    .locals 3
    ...
    invoke-direct {p0, v2, v0, v1}, Lru/yandex/speechkit/internal/WebSocket$1;->onFailure(ILjava/lang/String;Z)V
...
.method private logDuration(Ljava/lang/String;J)V
    ...
    invoke-virtual {p2, p1, v0}, Lru/yandex/speechkit/internal/EventLoggerImpl;->reportEventWithUuidAndVersion(Ljava/lang/String;Ljava/util/Map;)V
...
.method private onFailure(ILjava/lang/String;Z)V
    ...
    iget-object v0, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-virtual {v0}, Lru/yandex/speechkit/internal/NativeHandleHolder;->getNativeHandle()J

    move-result-wide v1

    invoke-static {v0, v1, v2, p1, p2}, Lru/yandex/speechkit/internal/WebSocket;->j(Lru/yandex/speechkit/internal/WebSocket;JILjava/lang/String;)V

    iget-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;
    ...
    :try_start_0
    iget-object p2, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-virtual {p2}, Lru/yandex/speechkit/internal/WebSocket;->close()V
    ...
    invoke-static {p2}, Lru/yandex/speechkit/internal/WebSocket;->e(Lru/yandex/speechkit/internal/WebSocket;)V
...
.method public onBinaryMessage(Lru/speechkit/ws/client/i0;[B)V
    ...
    invoke-static {p1, v0, v1, p2}, Lru/yandex/speechkit/internal/WebSocket;->f(Lru/yandex/speechkit/internal/WebSocket;J[B)V
...
.method public onConnectError(Lru/speechkit/ws/client/i0;Lru/speechkit/ws/client/WebSocketException;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p3, p1, p2}, Lru/yandex/speechkit/internal/WebSocket$1;->onFailure(ILjava/lang/String;Z)V
...
.method public onConnected(Lru/speechkit/ws/client/i0;Ljava/util/Map;Ljava/lang/String;)V
    ...
    invoke-static {p2, v0, v1}, Lru/yandex/speechkit/internal/WebSocket;->h(Lru/yandex/speechkit/internal/WebSocket;J)V
    ...
    :try_start_0
    iget-object p3, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-static {p3}, Lru/yandex/speechkit/internal/WebSocket;->d(Lru/yandex/speechkit/internal/WebSocket;)Lru/speechkit/ws/client/i0;

    move-result-object p3

    iget-object v0, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-static {v0}, Lru/yandex/speechkit/internal/WebSocket;->b(Lru/yandex/speechkit/internal/WebSocket;)J
    ...
    invoke-static {p1}, Lru/yandex/speechkit/internal/WebSocket;->b(Lru/yandex/speechkit/internal/WebSocket;)J
...
.method public onConnectionStateChanged(Lru/speechkit/ws/client/i0;Lmain/java/ru/speechkit/ws/client/WebSocketConnectState;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1, p3}, Lru/yandex/speechkit/internal/WebSocket;->i(Lru/yandex/speechkit/internal/WebSocket;JLjava/lang/String;)V

    iget-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-static {p1, p2}, Lru/yandex/speechkit/internal/WebSocket;->m(Lru/yandex/speechkit/internal/WebSocket;Lmain/java/ru/speechkit/ws/client/WebSocketConnectState;)V
...
.method public onDisconnected(Lru/speechkit/ws/client/i0;Lru/speechkit/ws/client/m0;Lru/speechkit/ws/client/m0;Z)V
    ...
    invoke-static {p1, p2, p3}, Lru/yandex/speechkit/internal/WebSocket;->g(Lru/yandex/speechkit/internal/WebSocket;J)V
...
.method public onError(Lru/speechkit/ws/client/i0;Lru/speechkit/ws/client/WebSocketException;)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lru/yandex/speechkit/internal/WebSocket$1;->onFailure(ILjava/lang/String;Z)V
...
.method public onFrameSent(Lru/speechkit/ws/client/i0;Lru/speechkit/ws/client/m0;)V
    ...
    invoke-static {p1}, Lru/yandex/speechkit/internal/WebSocket;->c(Lru/yandex/speechkit/internal/WebSocket;)J
    ...
    iget-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->pongTimerTask:Ljava/util/TimerTask;

    if-nez p1, :cond_0

    new-instance p1, Lru/yandex/speechkit/internal/WebSocket$1$1;

    invoke-direct {p1, p0}, Lru/yandex/speechkit/internal/WebSocket$1$1;-><init>(Lru/yandex/speechkit/internal/WebSocket$1;)V

    iput-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->pongTimerTask:Ljava/util/TimerTask;

    iget-object p2, p0, Lru/yandex/speechkit/internal/WebSocket$1;->pongTimer:Ljava/util/Timer;

    iget-object v0, p0, Lru/yandex/speechkit/internal/WebSocket$1;->this$0:Lru/yandex/speechkit/internal/WebSocket;

    invoke-static {v0}, Lru/yandex/speechkit/internal/WebSocket;->c(Lru/yandex/speechkit/internal/WebSocket;)J
...
.method public onPongFrame(Lru/speechkit/ws/client/i0;Lru/speechkit/ws/client/m0;)V
    ...
    :cond_0
    iget-object p1, p0, Lru/yandex/speechkit/internal/WebSocket$1;->pongTimer:Ljava/util/Timer;
    ...
    invoke-static {p1, v0, v1}, Lru/yandex/speechkit/internal/WebSocket;->k(Lru/yandex/speechkit/internal/WebSocket;J)V
...
.method public onTextMessage(Lru/speechkit/ws/client/i0;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0, v1, p2}, Lru/yandex/speechkit/internal/WebSocket;->l(Lru/yandex/speechkit/internal/WebSocket;JLjava/lang/String;)V
