...
.field private final j:Lff3/e;


# direct methods
.method public constructor <init>(Landroidx/car/app/q;Lxe3/a;Lff3/e;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/car/app/g0;-><init>(Landroidx/car/app/q;)V

    iput-object p2, p0, Ljh3/f;->i:Lxe3/a;

    iput-object p3, p0, Ljh3/f;->j:Lff3/e;
...
.method public static m(Ljh3/f;)V
    .locals 3

    iget-object v0, p0, Ljh3/f;->i:Lxe3/a;

    sget-object v1, Lru/yandex/yandexnavi/projected/platformkit/presentation/error/Message;->NAVIGATION_RESUME:Lru/yandex/yandexnavi/projected/platformkit/presentation/error/Message;
    ...
    iget-object p0, p0, Ljh3/f;->j:Lff3/e;

    const/4 v0, 0x0

    check-cast p0, Lru/yandex/yandexnavi/projected/platformkit/data/repo/protect/d;

    invoke-virtual {p0, v0}, Lru/yandex/yandexnavi/projected/platformkit/data/repo/protect/d;->c(Z)V
...
.method public final j()Landroidx/car/app/model/e1;
    ...
    sget v2, Lys1/b;->projected_kit_navigation_suspended_screen_description:I
    ...
    sget v3, Lys1/b;->projected_kit_navigation_suspended_screen_title:I
    ...
    sget v3, Lys1/b;->projected_kit_navigation_suspended_screen_action:I
