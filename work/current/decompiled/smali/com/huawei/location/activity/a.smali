...
# direct methods
.method public constructor <init>(Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
...
.method public final onActivityTransition(Lcom/huawei/hms/location/entity/activity/ActivityTransitionResult;)V
    ...
    iget-object v1, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
    ...
    iget-object v0, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
    ...
    iget-object v3, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
    ...
    iget-object v4, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
    ...
    iget-object p1, p0, Lcom/huawei/location/activity/a;->a:Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;
    ...
    check-cast v5, Lcom/huawei/hms/location/entity/activity/ActivityTransitionEvent;

    new-instance v6, Lcom/huawei/hms/location/ActivityConversionData;

    invoke-virtual {v5}, Lcom/huawei/hms/location/entity/activity/ActivityTransitionEvent;->getActivityType()I

    move-result v7

    add-int/lit8 v7, v7, 0x64

    invoke-virtual {v5}, Lcom/huawei/hms/location/entity/activity/ActivityTransitionEvent;->getTransitionType()I

    move-result v8

    invoke-virtual {v5}, Lcom/huawei/hms/location/entity/activity/ActivityTransitionEvent;->getElapsedRealTimeNanos()J

    move-result-wide v9

    invoke-direct {v6, v7, v8, v9, v10}, Lcom/huawei/hms/location/ActivityConversionData;-><init>(IIJ)V
    ...
    :cond_2
    new-instance v3, Lcom/huawei/hms/location/ActivityConversionResponse;

    invoke-direct {v3, v4}, Lcom/huawei/hms/location/ActivityConversionResponse;-><init>(Ljava/util/List;)V

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "sending transition result:"
    ...
    const-string v3, "com.huawei.hms.location.internal.EXTRA_ACTIVITY_CONVERSION_RESULT"
    ...
    invoke-static {v3}, Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;->access$100(Lcom/huawei/location/activity/RequestActivityConversionUpdatesTaskCall;)Landroid/app/PendingIntent;
