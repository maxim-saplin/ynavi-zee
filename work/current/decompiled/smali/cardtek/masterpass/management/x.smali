.class public final Lcardtek/masterpass/management/x;
...
.field final synthetic tk:Lcardtek/masterpass/interfaces/LinkCardToClientListener;


# direct methods
.method public constructor <init>(Lcardtek/masterpass/management/b;Ljava/lang/String;Ljava/lang/String;Lcardtek/masterpass/interfaces/LinkCardToClientListener;)V
    .locals 0

    iput-object p1, p0, Lcardtek/masterpass/management/x;->sA:Lcardtek/masterpass/management/b;

    iput-object p2, p0, Lcardtek/masterpass/management/x;->sy:Ljava/lang/String;

    iput-object p3, p0, Lcardtek/masterpass/management/x;->sz:Ljava/lang/String;

    iput-object p4, p0, Lcardtek/masterpass/management/x;->tk:Lcardtek/masterpass/interfaces/LinkCardToClientListener;
...
.method public final run()V
    ...
    iget-object v9, p0, Lcardtek/masterpass/management/x;->sy:Ljava/lang/String;

    iget-object v10, p0, Lcardtek/masterpass/management/x;->sA:Lcardtek/masterpass/management/b;

    invoke-static {v10}, Lcardtek/masterpass/management/b;->d(Lcardtek/masterpass/management/b;)Ljava/lang/String;

    move-result-object v10

    iget-object v11, p0, Lcardtek/masterpass/management/x;->sz:Ljava/lang/String;

    invoke-direct {v8, v9, v10, v11}, Lk/h;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v9, p0, Lcardtek/masterpass/management/x;->sA:Lcardtek/masterpass/management/b;
    ...
    sget-object v10, Lcardtek/masterpass/management/aa;->tv:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcardtek/masterpass/management/x;->tk:Lcardtek/masterpass/interfaces/LinkCardToClientListener;

    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/LinkCardToClientListener;->onVerifyUser(Lcardtek/masterpass/response/ServiceResult;)V
    ...
    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/LinkCardToClientListener;->onServiceError(Lcardtek/masterpass/response/ServiceError;)V
    :try_end_1
    ...
    :goto_5
    iget-object v2, p0, Lcardtek/masterpass/management/x;->tk:Lcardtek/masterpass/interfaces/LinkCardToClientListener;

    invoke-interface {v2, v1}, Lcardtek/masterpass/interfaces/LinkCardToClientListener;->onInternalError(Lcardtek/masterpass/response/InternalError;)V
