.class public final Lcardtek/masterpass/management/v;
...
.field final synthetic th:Lcardtek/masterpass/attributes/MasterPassEditText;

.field final synthetic ti:Lcardtek/masterpass/interfaces/ValidateTransactionListener;


# direct methods
.method public constructor <init>(Lcardtek/masterpass/management/b;Lcardtek/masterpass/attributes/MasterPassEditText;Lcardtek/masterpass/interfaces/ValidateTransactionListener;Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Lcardtek/masterpass/management/v;->sA:Lcardtek/masterpass/management/b;

    iput-object p2, p0, Lcardtek/masterpass/management/v;->th:Lcardtek/masterpass/attributes/MasterPassEditText;

    iput-object p3, p0, Lcardtek/masterpass/management/v;->ti:Lcardtek/masterpass/interfaces/ValidateTransactionListener;

    iput-object p4, p0, Lcardtek/masterpass/management/v;->sz:Ljava/lang/String;
...
.method public final run()V
    ...
    const-string v7, "RefNo"

    :try_start_0
    iget-object v8, p0, Lcardtek/masterpass/management/v;->th:Lcardtek/masterpass/attributes/MasterPassEditText;

    if-eqz v8, :cond_c

    invoke-virtual {v8}, Lcardtek/masterpass/attributes/MasterPassEditText;->isEmpty()Z
    ...
    invoke-virtual {v8}, Lcardtek/masterpass/attributes/MasterPassEditText;->validate()Z

    move-result v8

    if-eqz v8, :cond_b

    iget-object v8, p0, Lcardtek/masterpass/management/v;->sA:Lcardtek/masterpass/management/b;

    invoke-static {v8}, Lcardtek/masterpass/management/b;->a(Lcardtek/masterpass/management/b;)Lcardtek/masterpass/management/EncryptionHelper;

    move-result-object v8

    iget-object v9, p0, Lcardtek/masterpass/management/v;->th:Lcardtek/masterpass/attributes/MasterPassEditText;

    invoke-virtual {v8, v9}, Lcardtek/masterpass/management/EncryptionHelper;->getEncData(Lcardtek/masterpass/attributes/MasterPassEditText;)Ljava/lang/String;
    ...
    iget-object v11, p0, Lcardtek/masterpass/management/v;->sz:Ljava/lang/String;

    invoke-direct {v9, v8, v10, v11}, Lk/q;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, p0, Lcardtek/masterpass/management/v;->sA:Lcardtek/masterpass/management/b;

    invoke-static {v8}, Lcardtek/masterpass/management/b;->b(Lcardtek/masterpass/management/b;)Lcardtek/masterpass/management/a;

    move-result-object v8

    sget-object v10, Lcardtek/masterpass/management/aa;->tz:Ljava/lang/String;

    invoke-virtual {v8, v9, v10}, Lcardtek/masterpass/management/a;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v0, Lcardtek/masterpass/results/ValidateTransactionResult;

    invoke-direct {v0}, Lcardtek/masterpass/results/ValidateTransactionResult;-><init>()V

    invoke-virtual {v8, v7}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcardtek/masterpass/results/ValidateTransactionResult;->setRefNo(Ljava/lang/String;)V

    invoke-virtual {v8, v10}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcardtek/masterpass/results/ValidateTransactionResult;->setToken(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcardtek/masterpass/results/ValidateTransactionResult;->setCardUniqueId(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcardtek/masterpass/management/ServiceResponse;->setCardUniqueId(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0}, Lcardtek/masterpass/response/ServiceError;->setCardUniqueId(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcardtek/masterpass/management/ServiceResponse;->getCardUniqueId()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcardtek/masterpass/response/ServiceResult;->setCardUniqueId(Ljava/lang/String;)V

    iget-object v1, p0, Lcardtek/masterpass/management/v;->ti:Lcardtek/masterpass/interfaces/ValidateTransactionListener;

    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/ValidateTransactionListener;->onVerifyUser(Lcardtek/masterpass/response/ServiceResult;)V

    return-void

    :cond_9
    instance-of v1, v0, Lcardtek/masterpass/results/ValidateTransactionResult;

    if-eqz v1, :cond_a

    iget-object v1, p0, Lcardtek/masterpass/management/v;->ti:Lcardtek/masterpass/interfaces/ValidateTransactionListener;

    check-cast v0, Lcardtek/masterpass/results/ValidateTransactionResult;

    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/ValidateTransactionListener;->onSuccess(Lcardtek/masterpass/results/ValidateTransactionResult;)V
    ...
    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/ValidateTransactionListener;->onServiceError(Lcardtek/masterpass/response/ServiceError;)V
    ...
    sget-object v1, Lcardtek/masterpass/util/a;->uL:Lcardtek/masterpass/util/a;
    ...
    invoke-interface {v1, v0}, Lcardtek/masterpass/interfaces/ValidateTransactionListener;->onInternalError(Lcardtek/masterpass/response/InternalError;)V
    ...
    sget-object v1, Lcardtek/masterpass/util/a;->uK:Lcardtek/masterpass/util/a;
    ...
    :goto_4
    iget-object v2, p0, Lcardtek/masterpass/management/v;->ti:Lcardtek/masterpass/interfaces/ValidateTransactionListener;

    invoke-interface {v2, v1}, Lcardtek/masterpass/interfaces/ValidateTransactionListener;->onInternalError(Lcardtek/masterpass/response/InternalError;)V
