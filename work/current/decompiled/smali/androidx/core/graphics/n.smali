...
.method public static j(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/n;->l(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Landroidx/core/graphics/n;->l(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public static k([Landroidx/core/provider/o;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Landroidx/core/provider/o;->c()Landroid/net/Uri;
    ...
    invoke-virtual {v4}, Landroidx/core/provider/o;->d()I
    ...
    invoke-virtual {v4}, Landroidx/core/provider/o;->e()Z
    ...
    invoke-virtual {v4}, Landroidx/core/provider/o;->b()I
...
# virtual methods
.method public final b(Landroid/content/Context;Landroidx/core/content/res/f;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 6

    const/4 p1, 0x0

    :try_start_0
    invoke-virtual {p2}, Landroidx/core/content/res/f;->a()[Landroidx/core/content/res/g;
    ...
    invoke-virtual {v3}, Landroidx/core/content/res/g;->b()I

    move-result v5

    invoke-direct {v4, p3, v5}, Landroid/graphics/fonts/Font$Builder;-><init>(Landroid/content/res/Resources;I)V

    invoke-virtual {v3}, Landroidx/core/content/res/g;->e()I
    ...
    invoke-virtual {v3}, Landroidx/core/content/res/g;->f()Z
    ...
    invoke-virtual {v3}, Landroidx/core/content/res/g;->c()I
    ...
    invoke-virtual {v3}, Landroidx/core/content/res/g;->d()Ljava/lang/String;
...
.method public final c(Landroid/content/Context;[Landroidx/core/provider/o;I)Landroid/graphics/Typeface;
    .locals 1
    ...
    :try_start_0
    invoke-static {p2, p1}, Landroidx/core/graphics/n;->k([Landroidx/core/provider/o;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
...
.method public final d(Landroid/content/Context;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1}, Landroidx/core/graphics/n;->k([Landroidx/core/provider/o;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Landroidx/core/provider/o;

    invoke-static {v4, p1}, Landroidx/core/graphics/n;->k([Landroidx/core/provider/o;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-static {v0, p3}, Landroidx/core/graphics/n;->j(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public final g([Landroidx/core/provider/o;I)Landroidx/core/provider/o;
    .locals 0
