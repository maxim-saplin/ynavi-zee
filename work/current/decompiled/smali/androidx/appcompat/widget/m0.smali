...
.method public final b(Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Ln/j;->AppCompatSeekBar:[I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;

    invoke-virtual {v1}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v2

    sget-object v3, Ln/j;->AppCompatSeekBar:[I
    ...
    sget p1, Ln/j;->AppCompatSeekBar_android_thumb:I

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/s4;->h(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p2, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;

    invoke-virtual {p2, p1}, Landroid/widget/AbsSeekBar;->setThumb(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    sget p1, Ln/j;->AppCompatSeekBar_tickMark:I

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/s4;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iget-object p2, p0, Landroidx/appcompat/widget/m0;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object p1, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;

    invoke-virtual {p1}, Landroid/view/View;->invalidate()V

    sget p1, Ln/j;->AppCompatSeekBar_tickMarkTintMode:I
    ...
    invoke-virtual {v0, p1, v1}, Landroidx/appcompat/widget/s4;->k(II)I

    move-result p1

    iget-object v1, p0, Landroidx/appcompat/widget/m0;->g:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p1, v1}, Landroidx/appcompat/widget/x1;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p1

    iput-object p1, p0, Landroidx/appcompat/widget/m0;->g:Landroid/graphics/PorterDuff$Mode;

    iput-boolean p2, p0, Landroidx/appcompat/widget/m0;->i:Z

    :cond_4
    sget p1, Ln/j;->AppCompatSeekBar_tickMarkTint:I
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/m0;->f:Landroid/content/res/ColorStateList;
...
.method public final e(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/m0;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/m0;->d:Landroid/widget/SeekBar;
