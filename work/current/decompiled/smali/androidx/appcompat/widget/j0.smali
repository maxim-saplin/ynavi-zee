...
.method public constructor <init>(Landroid/widget/AbsSeekBar;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/j0;->a:Landroid/widget/ProgressBar;
...
.method public final a()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/j0;->b:Landroid/graphics/Bitmap;
...
.method public b(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/j0;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroidx/appcompat/widget/j0;->c:[I
    ...
    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/s4;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/j0;->a:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p0, v7, v0}, Landroidx/appcompat/widget/j0;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/s4;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Landroidx/appcompat/widget/j0;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Landroidx/core/graphics/drawable/e;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_8

    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/j0;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {v0, p2}, Landroidx/core/graphics/drawable/e;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/j0;->c(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/j0;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v1, p0, Landroidx/appcompat/widget/j0;->b:Landroid/graphics/Bitmap;
