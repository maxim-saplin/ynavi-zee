...
.method public constructor <init>(Lr20/a;)V
    ...
    iput-object p1, p0, Lo30/c;->a:Lr20/a;

    return-void
.end method

.method public static b(Lo30/c;Ljava/lang/String;)V
    .locals 0

    iget-object p0, p0, Lo30/c;->a:Lr20/a;

    invoke-virtual {p0, p1}, Lr20/a;->m(Ljava/lang/String;)V
...
.method public final a(Landroid/view/Menu;Ljava/lang/String;ZLcom/yandex/messaging/internal/s;)V
    ...
    sget-object p4, Lcom/yandex/messaging/internal/storage/chats/ChatRightsFlag;->ChangeRole:Lcom/yandex/messaging/internal/storage/chats/ChatRightsFlag;

    invoke-virtual {p3, p4}, Lcom/yandex/messaging/internal/storage/chats/b;->r(Lcom/yandex/messaging/internal/storage/chats/ChatRightsFlag;)Z

    move-result p4

    if-eqz p4, :cond_1

    sget-object p4, Lcom/yandex/messaging/internal/storage/chats/ChatRightsFlag;->AddUsers:Lcom/yandex/messaging/internal/storage/chats/ChatRightsFlag;
    ...
    :cond_0
    sget p3, Lcom/yandex/messaging/v0;->chat_info_remove_from_admin:I
