...
.field private comfortClass:Ljava/lang/String;

.field private comfortClass__is_initialized:Z
...
.method public constructor <init>()V
    ...
    .line 5
    iput-boolean v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category__is_initialized:Z

    .line 6
    iput-boolean v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass__is_initialized:Z
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 13
    invoke-direct/range {p0 .. p5}, Lcom/yandex/mapkit/transport/masstransit/Thread;->init(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Lcom/yandex/runtime/NativeObject;
    ...
    .line 20
    iput-object p4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category:Ljava/util/List;

    .line 21
    iput-boolean p1, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category__is_initialized:Z

    .line 22
    iput-object p5, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass:Ljava/lang/String;

    .line 23
    iput-boolean p1, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass__is_initialized:Z
    ...
    const-string p2, "Required field \"category\" cannot be null"
    ...
    const-string p2, "Required field \"essentialStops\" cannot be null"
...
.method private native getCategory__Native()Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/List<",
...
.method private native getComfortClass__Native()Ljava/lang/String;
.end method
...
.method public static getNativeName()Ljava/lang/String;
    ...
    const-string v0, "yandex::maps::mapkit::transport::masstransit::Thread"

    return-object v0
.end method

.method private native init(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Lcom/yandex/runtime/NativeObject;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
# virtual methods
.method public declared-synchronized getCategory()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category__is_initialized:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/yandex/mapkit/transport/masstransit/Thread;->getCategory__Native()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category:Ljava/util/List;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category:Ljava/util/List;
    :try_end_0
...
.method public declared-synchronized getComfortClass()Ljava/lang/String;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-boolean v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass__is_initialized:Z

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/yandex/mapkit/transport/masstransit/Thread;->getComfortClass__Native()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass:Ljava/lang/String;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public serialize(Lcom/yandex/runtime/bindings/Archive;)V
    ...
    const-class v1, Lcom/yandex/mapkit/transport/masstransit/ThreadCategory;

    const-class v2, Lcom/yandex/mapkit/transport/masstransit/EssentialStop;
    ...
    iput-boolean v4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->id__is_initialized:Z
    ...
    iput-boolean v4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->essentialStops__is_initialized:Z
    ...
    iput-boolean v4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->description__is_initialized:Z
    ...
    iput-boolean v4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category__is_initialized:Z
    ...
    iput-object v10, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass:Ljava/lang/String;

    iput-boolean v4, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->comfortClass__is_initialized:Z

    iget-object v6, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->id:Ljava/lang/String;

    iget-object v7, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->essentialStops:Ljava/util/List;

    iget-object v8, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->description:Ljava/lang/String;

    iget-object v9, p0, Lcom/yandex/mapkit/transport/masstransit/Thread;->category:Ljava/util/List;

    move-object v5, p0

    invoke-direct/range {v5 .. v10}, Lcom/yandex/mapkit/transport/masstransit/Thread;->init(Ljava/lang/String;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Lcom/yandex/runtime/NativeObject;
