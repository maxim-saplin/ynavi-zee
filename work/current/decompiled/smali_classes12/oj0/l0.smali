...
# static fields
.field public static final a:Loj0/l0;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Loj0/l0;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Loj0/l0;->a:Loj0/l0;

    const-string v0, "triggeredTestIds"

    const-string v1, "triggeredExperimentSet"

    const-string v2, "testIds"
    ...
    sput-object v0, Loj0/l0;->b:Ljava/util/List;
...
.method public final a(Ly3/g;Lcom/apollographql/apollo3/api/t;)Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Loj0/l0;->b:Ljava/util/List;
    ...
    new-instance p1, Lnj0/t0;

    invoke-direct {p1, v0, v1, v2}, Lnj0/t0;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;)V

    return-object p1

    :cond_0
    sget-object v2, Loj0/m0;->a:Loj0/m0;
    ...
    invoke-direct {v3, v2}, Lcom/apollographql/apollo3/api/h0;-><init>(Lcom/apollographql/apollo3/api/a;)V

    new-instance v2, Lcom/apollographql/apollo3/api/f0;

    invoke-direct {v2, v3}, Lcom/apollographql/apollo3/api/f0;-><init>(Lcom/apollographql/apollo3/api/a;)V

    invoke-virtual {v2, p1, p2}, Lcom/apollographql/apollo3/api/f0;->c(Ly3/g;Lcom/apollographql/apollo3/api/t;)Ljava/util/ArrayList;
...
.method public final b(Ly3/h;Lcom/apollographql/apollo3/api/t;Ljava/lang/Object;)V
    ...
    invoke-virtual {p3}, Lnj0/t0;->a()Ljava/lang/String;
    ...
    const-string v1, "triggeredTestIds"

    invoke-interface {p1, v1}, Ly3/h;->w3(Ljava/lang/String;)Ly3/h;

    invoke-virtual {p3}, Lnj0/t0;->c()Ljava/lang/String;

    move-result-object v1

    invoke-interface {v0, p1, p2, v1}, Lcom/apollographql/apollo3/api/a;->b(Ly3/h;Lcom/apollographql/apollo3/api/t;Ljava/lang/Object;)V

    const-string v0, "triggeredExperimentSet"

    invoke-interface {p1, v0}, Ly3/h;->w3(Ljava/lang/String;)Ly3/h;

    sget-object v0, Loj0/m0;->a:Loj0/m0;
    ...
    invoke-virtual {p3}, Lnj0/t0;->b()Ljava/util/List;
