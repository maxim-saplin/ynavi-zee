.class public Lcom/google/android/exoplayer2/trackselection/j0;
...
.field private static final y:Ljava/lang/String; = "YAdaptiveTrackSelection"

.field public static final z:I = 0x2710


# instance fields
.field protected final j:Lcom/google/android/exoplayer2/upstream/g;
...
.field private final r:Lcom/google/common/collect/ImmutableList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lcom/google/android/exoplayer2/trackselection/h0;",
            ">;"
        }
    .end annotation
.end field

.field protected final s:Lcom/google/android/exoplayer2/util/f;
...
.method public constructor <init>(Lcom/google/android/exoplayer2/source/k2;[IILcom/google/android/exoplayer2/upstream/g;JJJIIFFLcom/google/common/collect/ImmutableList;Lcom/google/android/exoplayer2/util/f;)V
    ...
    const-string v1, "YAdaptiveTrackSelection"
    ...
    :goto_0
    iput-object v3, v0, Lcom/google/android/exoplayer2/trackselection/j0;->j:Lcom/google/android/exoplayer2/upstream/g;

    const-wide/16 v3, 0x3e8

    mul-long v5, p5, v3

    iput-wide v5, v0, Lcom/google/android/exoplayer2/trackselection/j0;->k:J

    mul-long v5, p7, v3

    iput-wide v5, v0, Lcom/google/android/exoplayer2/trackselection/j0;->l:J

    mul-long/2addr v1, v3

    iput-wide v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->m:J

    move/from16 v1, p11

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->n:I

    move/from16 v1, p12

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->o:I

    move/from16 v1, p13

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->p:F

    move/from16 v1, p14

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->q:F
    ...
    iput-object v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->r:Lcom/google/common/collect/ImmutableList;

    move-object/from16 v1, p16

    iput-object v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->s:Lcom/google/android/exoplayer2/util/f;

    const/high16 v1, 0x3f800000    # 1.0f

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->t:F

    const/4 v1, 0x0

    iput v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->v:I

    const-wide v1, -0x7fffffffffffffffL    # -4.9E-324

    iput-wide v1, v0, Lcom/google/android/exoplayer2/trackselection/j0;->w:J
...
.method public final a()I
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/trackselection/j0;->u:I
...
.method public final disable()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/trackselection/j0;->x:Lcom/google/android/exoplayer2/source/chunk/v;
...
.method public final enable()V
    ...
    iput-wide v0, p0, Lcom/google/android/exoplayer2/trackselection/j0;->w:J
...
.method public final h(JLjava/util/List;)I
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/trackselection/j0;->s:Lcom/google/android/exoplayer2/util/f;
    ...
    iget-wide v2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->w:J
    ...
    iget-object v3, p0, Lcom/google/android/exoplayer2/trackselection/j0;->x:Lcom/google/android/exoplayer2/source/chunk/v;
    ...
    :goto_1
    iput-object v2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->x:Lcom/google/android/exoplayer2/source/chunk/v;
    ...
    iget v6, p0, Lcom/google/android/exoplayer2/trackselection/j0;->t:F

    invoke-static {v6, v4, v5}, Lcom/google/android/exoplayer2/util/h1;->F(FJ)J

    move-result-wide v4

    iget-wide v6, p0, Lcom/google/android/exoplayer2/trackselection/j0;->m:J
    ...
    :cond_4
    invoke-static {p3}, Lcom/google/android/exoplayer2/trackselection/j0;->w(Ljava/util/List;)J
    ...
    iget v1, p0, Lcom/google/android/exoplayer2/trackselection/j0;->t:F
    ...
    iget v8, p0, Lcom/google/android/exoplayer2/trackselection/j0;->o:I
    ...
    iget v5, p0, Lcom/google/android/exoplayer2/trackselection/j0;->n:I
...
.method public i(JJJLjava/util/List;[Lcom/google/android/exoplayer2/source/chunk/w;)V
    ...
    iget p8, p0, Lcom/google/android/exoplayer2/trackselection/j0;->v:I

    if-nez p8, :cond_0

    const/4 p3, 0x1

    iput p3, p0, Lcom/google/android/exoplayer2/trackselection/j0;->v:I
    ...
    :cond_0
    iget v2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->u:I
    ...
    invoke-virtual {p0, p5, p6, v0, v1}, Lcom/google/android/exoplayer2/trackselection/j0;->y(JJ)J
    ...
    :goto_2
    iput p8, p0, Lcom/google/android/exoplayer2/trackselection/j0;->v:I

    iput p7, p0, Lcom/google/android/exoplayer2/trackselection/j0;->u:I
...
.method public final p(F)V
    ...
    iput p1, p0, Lcom/google/android/exoplayer2/trackselection/j0;->t:F
...
.method public final t()I
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/trackselection/j0;->v:I

    return v0
.end method

.method public u(Lcom/google/android/exoplayer2/c1;IJ)Z
    .locals 0
...
.method public final v(J)I
    ...
    iget v1, p0, Lcom/google/android/exoplayer2/trackselection/j0;->p:F

    mul-float/2addr v0, v1

    float-to-long v0, v0

    iget-object v2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->j:Lcom/google/android/exoplayer2/upstream/g;
    ...
    iget-object v2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->r:Lcom/google/common/collect/ImmutableList;
    ...
    :goto_0
    iget-object v4, p0, Lcom/google/android/exoplayer2/trackselection/j0;->r:Lcom/google/common/collect/ImmutableList;
    ...
    check-cast v4, Lcom/google/android/exoplayer2/trackselection/h0;

    iget-wide v4, v4, Lcom/google/android/exoplayer2/trackselection/h0;->a:J
    ...
    check-cast v2, Lcom/google/android/exoplayer2/trackselection/h0;
    ...
    check-cast v3, Lcom/google/android/exoplayer2/trackselection/h0;

    iget-wide v4, v2, Lcom/google/android/exoplayer2/trackselection/h0;->a:J

    sub-long/2addr v0, v4

    long-to-float v0, v0

    iget-wide v6, v3, Lcom/google/android/exoplayer2/trackselection/h0;->a:J
    ...
    iget-wide v1, v2, Lcom/google/android/exoplayer2/trackselection/h0;->b:J

    iget-wide v3, v3, Lcom/google/android/exoplayer2/trackselection/h0;->b:J
    ...
    invoke-virtual {p0, v3, v4, v0, v1}, Lcom/google/android/exoplayer2/trackselection/j0;->u(Lcom/google/android/exoplayer2/c1;IJ)Z
...
.method public final x([Lcom/google/android/exoplayer2/source/chunk/w;Ljava/util/List;)J
    .locals 4
    ...
    iget p2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->u:I

    aget-object p1, p1, p2

    invoke-interface {p1}, Lcom/google/android/exoplayer2/source/chunk/w;->a()J

    move-result-wide v0

    invoke-interface {p1}, Lcom/google/android/exoplayer2/source/chunk/w;->i()J
    ...
    :cond_2
    invoke-static {p2}, Lcom/google/android/exoplayer2/trackselection/j0;->w(Ljava/util/List;)J
...
.method public final y(JJ)J
    ...
    iget-wide p1, p0, Lcom/google/android/exoplayer2/trackselection/j0;->k:J
    ...
    iget p2, p0, Lcom/google/android/exoplayer2/trackselection/j0;->q:F

    mul-float/2addr p1, p2

    float-to-long p1, p1

    iget-wide p3, p0, Lcom/google/android/exoplayer2/trackselection/j0;->k:J
