...
.method public static getLteCqi(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/w;->l(Landroid/telephony/SignalStrength;)Ljava/util/List;
...
.method private static getMobileSingalStrengthUpPPlatfrom(Landroid/content/Context;)I
    ...
    :cond_2
    :try_start_0
    invoke-static {}, Lcom/google/android/exoplayer2/mediacodec/w;->j()Ljava/lang/Class;

    move-result-object p0

    invoke-static {v0, p0}, Lcom/google/android/exoplayer2/mediacodec/w;->m(Landroid/telephony/SignalStrength;Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/w;->h(Ljava/lang/Object;)Landroid/telephony/CellSignalStrengthNr;

    move-result-object p0

    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/w;->z(Landroid/telephony/CellSignalStrengthNr;)I
    ...
    :cond_3
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/w;->l(Landroid/telephony/SignalStrength;)Ljava/util/List;
    ...
    :cond_4
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/w;->t(Landroid/telephony/SignalStrength;)Ljava/util/List;
    ...
    :cond_5
    invoke-static {}, Lcom/google/android/exoplayer2/mediacodec/w;->s()Ljava/lang/Class;
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/w;->i(Ljava/lang/Object;)Landroid/telephony/CellSignalStrengthTdscdma;

    move-result-object p0

    invoke-static {p0}, Lcom/google/android/exoplayer2/mediacodec/w;->c(Landroid/telephony/CellSignalStrengthTdscdma;)I
    ...
    :cond_6
    invoke-static {v0}, Lcom/google/android/exoplayer2/mediacodec/w;->x(Landroid/telephony/SignalStrength;)Ljava/util/List;
...
.method public static getNrCsiRsrp(Landroid/content/Context;)I
    ...
    invoke-static {p0, v1}, Lcom/google/android/exoplayer2/mediacodec/w;->m(Landroid/telephony/SignalStrength;Ljava/lang/Class;)Ljava/util/List;
...
.method public static getNrSignalInfo(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->h(Ljava/lang/Object;)Landroid/telephony/CellSignalStrengthNr;

    move-result-object v3

    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->z(Landroid/telephony/CellSignalStrengthNr;)I
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->B(Landroid/telephony/CellSignalStrengthNr;)I
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->C(Landroid/telephony/CellSignalStrengthNr;)I
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->D(Landroid/telephony/CellSignalStrengthNr;)I
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/mediacodec/w;->r(Landroid/telephony/CellSignalStrengthNr;)I
...
.method private static getSignalStrength(Landroid/content/Context;)Landroid/telephony/SignalStrength;
    ...
    invoke-static {p0}, Lcom/bumptech/glide/load/resource/bitmap/d;->m(Landroid/telephony/TelephonyManager;)Landroid/telephony/SignalStrength;
