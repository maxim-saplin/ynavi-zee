...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lx21/c;->b:Lkotlinx/serialization/KSerializer;

    invoke-interface {v0}, Ln41/i;->getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;

    move-result-object v0

    sput-object v0, Lx21/c;->c:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public final deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    sget-object v0, Lx21/c;->b:Lkotlinx/serialization/KSerializer;
    ...
    const-class v3, Ljason/statham/model/r;
    ...
    new-instance v1, Ljason/statham/model/q;

    invoke-virtual {v2}, Lkotlinx/serialization/json/JsonPrimitive;->getContent()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, v2}, Ljason/statham/model/q;-><init>(Ljava/lang/String;)V
    ...
    const-string v2, " fragment should be string or int, but actual value is "
    ...
    const-string v2, " fragments should be primitives, but actual value is "
    ...
    :cond_3
    new-instance p1, Ljason/statham/model/r;

    invoke-direct {p1, v0}, Ljason/statham/model/r;-><init>(Ljava/util/ArrayList;)V
...
.method public final getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v0, Lx21/c;->c:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public final serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    check-cast p2, Ljason/statham/model/r;

    sget-object v0, Lx21/c;->b:Lkotlinx/serialization/KSerializer;

    invoke-virtual {p2}, Ljason/statham/model/r;->a()Ljava/util/List;
    ...
    check-cast v2, Ljason/statham/model/o;

    instance-of v3, v2, Ljason/statham/model/q;

    if-eqz v3, :cond_0

    check-cast v2, Ljason/statham/model/q;

    invoke-virtual {v2}, Ljason/statham/model/q;->a()Ljava/lang/String;
    ...
    :cond_0
    instance-of v3, v2, Ljason/statham/model/p;

    if-eqz v3, :cond_1

    check-cast v2, Ljason/statham/model/p;

    invoke-virtual {v2}, Ljason/statham/model/p;->a()I
    ...
    invoke-direct {p2, v1}, Lkotlinx/serialization/json/JsonArray;-><init>(Ljava/util/List;)V
