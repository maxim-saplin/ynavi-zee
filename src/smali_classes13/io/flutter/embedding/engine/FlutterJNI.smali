...
.field private static asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/p; = null
...
# instance fields
.field private accessibilityDelegate:Lio/flutter/embedding/engine/o;

.field private deferredComponentManager:Lf01/a;
...
.field private localizationPlugin:Lio/flutter/plugin/localization/b;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Lio/flutter/embedding/engine/dart/p;
...
.method private static asyncWaitForVsync(J)V
    ...
    sget-object v0, Lio/flutter/embedding/engine/FlutterJNI;->asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/p;

    if-eqz v0, :cond_0

    check-cast v0, Lio/flutter/view/t;

    invoke-virtual {v0, p0, p1}, Lio/flutter/view/t;->a(J)V
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    new-instance v0, Lio/flutter/embedding/engine/n;

    invoke-direct {v0, p1, p2}, Lio/flutter/embedding/engine/n;-><init>(J)V

    invoke-static {p0, v0}, Le3/e;->i(Landroid/graphics/ImageDecoder$Source;Lio/flutter/embedding/engine/n;)Landroid/graphics/Bitmap;
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lio/flutter/embedding/engine/dart/p;

    if-eqz v0, :cond_0

    check-cast v0, Lio/flutter/embedding/engine/dart/o;

    invoke-virtual {v0, p1, p2}, Lio/flutter/embedding/engine/dart/o;->j(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p2, p4}, Lc01/b;->q(Landroid/graphics/ImageDecoder;Landroid/graphics/ColorSpace;)V

    invoke-static {p2}, Lc01/b;->C(Landroid/graphics/ImageDecoder;)V

    invoke-static {p3}, Lc01/b;->k(Landroid/graphics/ImageDecoder$ImageInfo;)Landroid/util/Size;
...
.method private updateCustomAccessibilityActions(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->accessibilityDelegate:Lio/flutter/embedding/engine/o;

    if-eqz v0, :cond_0

    check-cast v0, Lio/flutter/view/b;

    invoke-virtual {v0, p1, p2}, Lio/flutter/view/b;->f(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
...
.method private updateSemantics(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lio/flutter/view/b;->g(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lio/flutter/plugin/localization/b;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lio/flutter/plugin/localization/b;

    invoke-virtual {p1, v0}, Lio/flutter/plugin/localization/b;->c(Ljava/util/ArrayList;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/w;->x()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public destroyOverlaySurfaces()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/w;->z()V
...
.method public dispatchSemanticsAction(ILio/flutter/view/AccessibilityBridge$Action;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lio/flutter/plugin/common/d0;->b(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lio/flutter/embedding/engine/systemchannels/u0;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-virtual/range {v1 .. v6}, Lio/flutter/embedding/engine/dart/o;->i(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public loadLibrary(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1, v1}, Lcom/getkeepsafe/relinker/g;->b(Landroid/content/Context;Ljava/lang/String;)V
...
.method public onBeginFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/w;->L()V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/w;->M(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/w;->N(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public setAccessibilityDelegate(Lio/flutter/embedding/engine/o;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->accessibilityDelegate:Lio/flutter/embedding/engine/o;
...
.method public setAsyncWaitForVsyncDelegate(Lio/flutter/embedding/engine/p;)V
    .locals 0

    sput-object p1, Lio/flutter/embedding/engine/FlutterJNI;->asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/p;

    return-void
.end method

.method public setDeferredComponentManager(Lf01/a;)V
    .locals 0
    ...
    invoke-interface {p1}, Lf01/a;->a()V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lio/flutter/plugin/localization/b;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lio/flutter/plugin/localization/b;

    return-void
.end method

.method public setPlatformMessageHandler(Lio/flutter/embedding/engine/dart/p;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lio/flutter/embedding/engine/dart/p;
