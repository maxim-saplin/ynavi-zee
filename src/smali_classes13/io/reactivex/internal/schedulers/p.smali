...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean v0, Lio/reactivex/internal/schedulers/t;->b:Z
    ...
    sget-object v1, Lio/reactivex/internal/schedulers/t;->f:Ljava/util/Map;

    invoke-interface {v1, v0, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    iput-object p1, p0, Lio/reactivex/internal/schedulers/p;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final a(Ljava/lang/Runnable;)Lio/reactivex/disposables/b;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/internal/schedulers/p;->b(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
...
.method public final b(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    iget-boolean v0, p0, Lio/reactivex/internal/schedulers/p;->c:Z
...
.method public final d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lio/reactivex/internal/disposables/a;)Lio/reactivex/internal/schedulers/ScheduledRunnable;
    .locals 3
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/p;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final dispose()V
    ...
    iput-boolean v0, p0, Lio/reactivex/internal/schedulers/p;->c:Z

    iget-object v0, p0, Lio/reactivex/internal/schedulers/p;->b:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    .locals 3
...
.method public final f(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    .locals 8
    ...
    new-instance p4, Lio/reactivex/internal/schedulers/j;

    iget-object p5, p0, Lio/reactivex/internal/schedulers/p;->b:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {p4, p1, p5}, Lio/reactivex/internal/schedulers/j;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p4, p1}, Lio/reactivex/internal/schedulers/j;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
