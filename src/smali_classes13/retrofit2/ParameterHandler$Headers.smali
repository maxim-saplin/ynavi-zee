...
.method public bridge synthetic apply(Lretrofit2/RequestBuilder;Ljava/lang/Object;)V
    ...
    .line 1
    check-cast p2, Lokhttp3/u0;

    invoke-virtual {p0, p1, p2}, Lretrofit2/ParameterHandler$Headers;->apply(Lretrofit2/RequestBuilder;Lokhttp3/u0;)V

    return-void
.end method

.method public apply(Lretrofit2/RequestBuilder;Lokhttp3/u0;)V
    .locals 2

    if-eqz p2, :cond_0

    .line 2
    invoke-virtual {p1, p2}, Lretrofit2/RequestBuilder;->addHeaders(Lokhttp3/u0;)V
