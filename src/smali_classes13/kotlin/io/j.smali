...
.method public static i(Ljava/io/File;Ljava/io/File;)Z
    ...
    sget-object v0, Lkotlin/io/FilesKt__UtilsKt$copyRecursively$1;->h:Lkotlin/io/FilesKt__UtilsKt$copyRecursively$1;
    ...
    invoke-direct/range {v2 .. v8}, Lkotlin/io/i;-><init>(Ljava/io/File;Lkotlin/io/FileWalkDirection;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lv31/d;I)V

    new-instance v2, Lkotlin/io/FilesKt__UtilsKt$copyRecursively$2;

    invoke-direct {v2, v0}, Lkotlin/io/FilesKt__UtilsKt$copyRecursively$2;-><init>(Lv31/d;)V

    invoke-virtual {v9, v2}, Lkotlin/io/i;->h(Lv31/d;)Lkotlin/io/i;

    move-result-object v2

    new-instance v3, Lkotlin/io/g;

    invoke-direct {v3, v2}, Lkotlin/io/g;-><init>(Lkotlin/io/i;)V
    ...
    invoke-static {v2, p0}, Lkotlin/io/j;->r(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v5, p1}, Lkotlin/io/FileSystemException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v2, v5, v1, v4}, Lkotlin/io/j;->j(Ljava/io/File;Ljava/io/File;ZI)V
    ...
    invoke-direct {p0, v2}, Lkotlin/io/NoSuchFileException;-><init>(Ljava/io/File;)V
...
.method public static j(Ljava/io/File;Ljava/io/File;ZI)V
    .locals 1
...
.method public static k(Ljava/io/File;)Z
    ...
    invoke-direct {p0, v7}, Lkotlin/io/g;-><init>(Lkotlin/io/i;)V
    ...
    invoke-virtual {p0}, Lkotlin/collections/a;->next()Ljava/lang/Object;
...
.method public static l(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lkotlin/text/g0;->s0(Ljava/lang/String;CLjava/lang/String;)Ljava/lang/String;
...
.method public static final m(Lkotlin/io/a;)Lkotlin/io/a;
    .locals 6

    new-instance v0, Lkotlin/io/a;

    invoke-virtual {p0}, Lkotlin/io/a;->a()Ljava/io/File;

    move-result-object v1

    invoke-virtual {p0}, Lkotlin/io/a;->b()Ljava/util/List;
    ...
    :cond_3
    invoke-direct {v0, v1, v2}, Lkotlin/io/a;-><init>(Ljava/io/File;Ljava/util/List;)V
...
.method public static n(Ljava/io/File;)[B
    ...
    :cond_2
    new-instance v6, Lio/flutter/plugin/common/c0;
    ...
    invoke-static {v0, v6}, Lkotlin/io/m;->b(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v6}, Lio/flutter/plugin/common/c0;->b()[B
...
.method public static o(Ljava/io/File;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v2}, Lkotlin/io/m;->c(Ljava/io/Reader;Lkotlin/jvm/functions/Function1;)V
...
.method public static q(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1}, Lkotlin/io/m;->d(Ljava/lang/String;)I
    ...
    invoke-static {p0, p1}, Lkotlin/text/g0;->N(Ljava/lang/String;C)Z
...
.method public static final r(Ljava/io/File;Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkotlin/io/m;->h(Ljava/io/File;)Lkotlin/io/a;

    move-result-object v0

    invoke-static {v0}, Lkotlin/io/j;->m(Lkotlin/io/a;)Lkotlin/io/a;

    move-result-object v0

    invoke-static {p1}, Lkotlin/io/m;->h(Ljava/io/File;)Lkotlin/io/a;

    move-result-object v1

    invoke-static {v1}, Lkotlin/io/j;->m(Lkotlin/io/a;)Lkotlin/io/a;

    move-result-object v1

    invoke-virtual {v0}, Lkotlin/io/a;->a()Ljava/io/File;

    move-result-object v2

    invoke-virtual {v1}, Lkotlin/io/a;->a()Ljava/io/File;
    ...
    :cond_0
    invoke-virtual {v1}, Lkotlin/io/a;->c()I

    move-result v2

    invoke-virtual {v0}, Lkotlin/io/a;->c()I
    ...
    invoke-virtual {v0}, Lkotlin/io/a;->b()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lkotlin/io/a;->b()Ljava/util/List;
    ...
    invoke-static/range {v7 .. v12}, Lkotlin/collections/e0;->e0(Ljava/lang/Iterable;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Lkotlin/jvm/functions/Function1;I)V
...
.method public static t(Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {v1, p1, v0}, Lkotlin/io/j;->u(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
