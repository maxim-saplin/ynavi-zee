.class public final Lcom/yandex/alice/reminders/storage/p;
.super Landroidx/room/w0;
.source "SourceFile"


# instance fields
.field final synthetic b:Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;
...
.method public constructor <init>(Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;)V
    ...
    iput-object p1, p0, Lcom/yandex/alice/reminders/storage/p;->b:Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;
...
.method public final a(Landroidx/sqlite/db/framework/c;)V
    ...
    const-string v0, "CREATE TABLE IF NOT EXISTS `Reminder` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `guid` TEXT NOT NULL, `text` TEXT NOT NULL, `time` INTEGER NOT NULL, `timezone` TEXT NOT NULL, `actionLink` TEXT NOT NULL, `origin` TEXT NOT NULL, `opaque` TEXT)"

    const-string v1, "CREATE UNIQUE INDEX IF NOT EXISTS `index_Reminder_guid` ON `Reminder` (`guid`)"

    const-string v2, "CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)"

    const-string v3, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'f39624d4cfc5cd9a566f98b9cce6bfca\')"
...
.method public final b(Landroidx/sqlite/db/framework/c;)V
    ...
    const-string v0, "DROP TABLE IF EXISTS `Reminder`"

    invoke-virtual {p1, v0}, Landroidx/sqlite/db/framework/c;->k2(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/yandex/alice/reminders/storage/p;->b:Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;

    invoke-static {p1}, Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;->K(Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;)Ljava/util/List;
...
.method public final c(Landroidx/sqlite/db/framework/c;)V
    ...
    iget-object v0, p0, Lcom/yandex/alice/reminders/storage/p;->b:Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;

    invoke-static {v0}, Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;->L(Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;)Ljava/util/List;
...
.method public final d(Lw2/d;)V
    ...
    invoke-static {v0, p1}, Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;->M(Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;Lw2/d;)V
    ...
    invoke-static {v0}, Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;->N(Lcom/yandex/alice/reminders/storage/ReminderDatabase_Impl;)Ljava/util/List;
...
.method public final f(Lw2/d;)Landroidx/room/x0;
    ...
    const-string v8, "index_Reminder_guid"
    ...
    const-string v1, "Reminder(com.yandex.alice.reminders.data.Reminder).\n Expected:\n"
