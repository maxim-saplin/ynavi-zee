...
.method private doDecrypt()V
    ...
    const-string v1, "Fail to decrypt, errorMessage : "
    ...
    const-string v5, "appAuth.decrypt"
    ...
    :try_start_0
    iget-object v3, p0, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->cipherText:Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialCipherText;

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialCipherText;->checkParam(Z)V

    iget-object v3, p0, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->credential:Lcom/huawei/wisesecurity/ucs/credential/Credential;
    ...
    iget-object v5, p0, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->credential:Lcom/huawei/wisesecurity/ucs/credential/Credential;
    ...
    invoke-direct {v0, v5, v3, v6}, Lxc/c;-><init>(Ljava/security/Key;Lxc/a;Ljava/security/spec/AlgorithmParameterSpec;)V

    iget-object v3, p0, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->cipherText:Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialCipherText;

    invoke-virtual {v3}, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialCipherText;->getCipherBytes()[B

    move-result-object v3

    iget-object v5, v0, Lxc/c;->c:Lxc/a;

    invoke-static {v3}, Lru/yandex/yandexmaps/multiplatform/log/panel/impl/redux/j;->d([B)[B

    move-result-object v3

    iput-object v3, v5, Lxc/a;->b:[B
    ...
    invoke-virtual {v3, v0}, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialCipherText;->setPlainBytes([B)V

    invoke-virtual {v2, v4}, Lad/a;->e(I)Lad/a;
    :try_end_0
    ...
    :goto_3
    iget-object v1, p0, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->credentialClient:Lcom/huawei/wisesecurity/ucs/credential/CredentialClient;
...
.method private from(Ljava/lang/String;Lyc/a;)Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/huawei/wisesecurity/ucs/common/exception/UcsCryptoException;
...
.method public bridge synthetic from([B)Lxc/b;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public fromBase64(Ljava/lang/String;)Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;
    ...
    invoke-direct {p0, p1, v0}, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->from(Ljava/lang/String;Lyc/a;)Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;
...
.method public bridge synthetic fromBase64(Ljava/lang/String;)Lxc/b;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/huawei/wisesecurity/kfs/exception/CryptoException;
...
.method public bridge synthetic fromBase64Url(Ljava/lang/String;)Lxc/b;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/huawei/wisesecurity/kfs/exception/CryptoException;
...
.method public bridge synthetic fromHex(Ljava/lang/String;)Lxc/b;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/huawei/wisesecurity/kfs/exception/CryptoException;
...
.method public toBase64()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/huawei/wisesecurity/ucs/credential/crypto/cipher/CredentialDecryptHandler;->to(Lyc/b;)Ljava/lang/String;
