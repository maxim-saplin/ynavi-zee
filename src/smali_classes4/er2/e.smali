...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ler2/e;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Ler2/e;->b:Ljava/lang/String;
...
# virtual methods
.method public final a(Lgr2/d;)V
    .locals 11

    invoke-virtual {p1}, Lgr2/d;->a()Ljava/util/List;
    ...
    iget-object v4, p0, Ler2/e;->a:Landroid/content/Context;

    iget-object v5, p0, Ler2/e;->b:Ljava/lang/String;
    ...
    invoke-virtual {v6, v5, v7}, Landroid/content/Intent;->putParcelableArrayListExtra(Ljava/lang/String;Ljava/util/ArrayList;)Landroid/content/Intent;
    ...
    :goto_4
    iget-object v5, p0, Ler2/e;->a:Landroid/content/Context;
    ...
    :cond_a
    invoke-static {v7}, Lkotlin/collections/e0;->W(Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Ler2/e;->a:Landroid/content/Context;
    ...
    invoke-static {v1, p1, v4}, Landroid/content/ClipData;->newUri(Landroid/content/ContentResolver;Ljava/lang/CharSequence;Landroid/net/Uri;)Landroid/content/ClipData;
    ...
    :cond_f
    invoke-virtual {v6, p1}, Landroid/content/Intent;->setClipData(Landroid/content/ClipData;)V
    ...
    iget-object v0, p0, Ler2/e;->a:Landroid/content/Context;

    invoke-virtual {v0, p1, v9}, Landroid/content/Context;->startActivity(Landroid/content/Intent;Landroid/os/Bundle;)V
