...
.field private final k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;
...
.method public constructor <init>(Landroid/content/Context;Lru/yandex/yandexmaps/video/player/api/k;)V
    ...
    .line 5
    iput-object v0, p0, Ll91/d;->g:Lru/yandex/maps/uikit/common/recycler/d;

    .line 6
    iput-object p2, p0, Ll91/d;->h:Lru/yandex/yandexmaps/video/player/api/k;

    .line 7
    sget p2, Lm81/f;->snippet_gallery_video_view:I
    ...
    iput-object p1, p0, Ll91/d;->j:Lru/yandex/maps/uikit/common/recycler/c;

    .line 10
    sget p1, Lm81/e;->snippet_gallery_video_player_view:I
    ...
    .line 12
    check-cast p1, Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;

    iput-object p1, p0, Ll91/d;->k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;
    ...
    .line 16
    iget-object p2, p0, Ll91/d;->j:Lru/yandex/maps/uikit/common/recycler/c;
    ...
    iput-object v0, p0, Ll91/d;->l:Lru/yandex/maps/uikit/atomicviews/snippet/image/SnippetImageView;
...
.method public synthetic constructor <init>(Landroid/content/Context;Lru/yandex/yandexmaps/video/player/api/k;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 1
    :cond_0
    invoke-direct {p0, p1, p2}, Ll91/d;-><init>(Landroid/content/Context;Lru/yandex/yandexmaps/video/player/api/k;)V
...
.method public final M(Ljava/lang/Object;)V
    ...
    :goto_1
    iget-object v2, p0, Ll91/d;->i:Ljava/lang/String;
    ...
    :cond_2
    iput-object v1, p0, Ll91/d;->i:Ljava/lang/String;

    :cond_3
    iget-object v0, p0, Ll91/d;->l:Lru/yandex/maps/uikit/atomicviews/snippet/image/SnippetImageView;
    ...
    iget-object v1, p0, Ll91/d;->k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;
    ...
    :cond_4
    iget-object v0, p0, Ll91/d;->k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;

    invoke-virtual {p1}, Ly81/d;->c()Lpr2/f;

    move-result-object p1

    invoke-virtual {v0, p1}, Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;->setUxTraceFeatureStage(Lpr2/f;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Ll91/d;->i:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v1, p0, Ll91/d;->h:Lru/yandex/yandexmaps/video/player/api/k;

    if-eqz v1, :cond_0

    iget-object v2, p0, Ll91/d;->k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;

    iget-object v3, p0, Ll91/d;->l:Lru/yandex/maps/uikit/atomicviews/snippet/image/SnippetImageView;

    invoke-virtual {v1, v2, v3, v0}, Lru/yandex/yandexmaps/video/player/api/k;->l(Lru/yandex/yandexmaps/video/player/api/l;Landroid/widget/ImageView;Ljava/lang/String;)Lru/yandex/yandexmaps/video/player/api/d;

    move-result-object v1

    check-cast v1, Lib3/d;

    if-eqz v1, :cond_0

    iget-object v2, p0, Ll91/d;->k:Lru/yandex/yandexmaps/video/player/api/MapsVideoPlayerView;

    new-instance v3, Lru/yandex/yandexmaps/video/player/api/h;

    iget-object v4, p0, Ll91/d;->l:Lru/yandex/maps/uikit/atomicviews/snippet/image/SnippetImageView;

    invoke-virtual {v4}, Landroid/view/View;->getWidth()I

    move-result v4

    iget-object v5, p0, Ll91/d;->l:Lru/yandex/maps/uikit/atomicviews/snippet/image/SnippetImageView;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lru/yandex/yandexmaps/video/player/api/h;-><init>(IIIZ)V

    invoke-virtual {v1, v0, v2, v3}, Lib3/d;->i(Ljava/lang/String;Lru/yandex/video/player/b0;Lru/yandex/yandexmaps/video/player/api/h;)V
...
.method public getActionObserver()Lru/yandex/maps/uikit/common/recycler/c;
    ...
    iget-object v0, p0, Ll91/d;->g:Lru/yandex/maps/uikit/common/recycler/d;
