.class public final Lru/yandex/yandexmaps/glide/mapkit/n;
...
# direct methods
.method public constructor <init>(Landroid/net/Uri;Lkotlin/jvm/functions/Function0;Lio/reactivex/d0;F)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->b:Landroid/net/Uri;

    iput-object p3, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->c:Lio/reactivex/d0;

    iput p4, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->d:F

    invoke-static {p2}, Lkotlin/a;->c(Lkotlin/jvm/functions/Function0;)Lm31/h;

    move-result-object p1

    iput-object p1, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->e:Lm31/h;

    return-void
.end method

.method public static e(Lru/yandex/yandexmaps/glide/mapkit/n;Lio/reactivex/f0;)V
    .locals 4

    iget-object v0, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->e:Lm31/h;
    ...
    iget-object v2, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->b:Landroid/net/Uri;

    new-instance v3, Lru/yandex/yandexmaps/multiplatform/core/uri/f;

    invoke-direct {v3, v2}, Lru/yandex/yandexmaps/multiplatform/core/uri/f;-><init>(Landroid/net/Uri;)V

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "id"

    invoke-virtual {v3, v1}, Lru/yandex/yandexmaps/multiplatform/core/uri/f;->m(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget p0, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->d:F

    new-instance v2, Lru/yandex/yandexmaps/glide/mapkit/m;

    invoke-direct {v2, p1}, Lru/yandex/yandexmaps/glide/mapkit/m;-><init>(Lio/reactivex/f0;)V
...
.method public final cancel()V
    ...
    iget-object v0, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->f:Lio/reactivex/disposables/b;
...
.method public final d(Lcom/bumptech/glide/Priority;Lcom/bumptech/glide/load/data/d;)V
    ...
    iget-object v0, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->c:Lio/reactivex/d0;

    invoke-virtual {p1, v0}, Lio/reactivex/e0;->s(Lio/reactivex/d0;)Lio/reactivex/e0;

    move-result-object p1

    new-instance v7, Lru/yandex/yandexmaps/glide/mapkit/MapkitSearchBitmapUriDataFetcher$loadData$1;
    ...
    iput-object p1, p0, Lru/yandex/yandexmaps/glide/mapkit/n;->f:Lio/reactivex/disposables/b;
