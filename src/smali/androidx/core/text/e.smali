...
.method public constructor <init>(Landroid/text/PrecomputedText$Params;)V
    ...
    .line 14
    invoke-static {p1}, Landroid/support/v4/media/session/y;->m(Landroid/text/PrecomputedText$Params;)Landroid/text/TextPaint;
    ...
    .line 15
    invoke-static {p1}, Landroid/support/v4/media/session/y;->l(Landroid/text/PrecomputedText$Params;)Landroid/text/TextDirectionHeuristic;
    ...
    .line 16
    invoke-static {p1}, Landroid/support/v4/media/session/y;->b(Landroid/text/PrecomputedText$Params;)I
    ...
    .line 17
    invoke-static {p1}, Landroid/support/v4/media/session/y;->z(Landroid/text/PrecomputedText$Params;)I

    move-result v0

    iput v0, p0, Landroidx/core/text/e;->d:I
    ...
    :goto_0
    iput-object p1, p0, Landroidx/core/text/e;->e:Landroid/text/PrecomputedText$Params;
...
.method public constructor <init>(Landroid/text/TextPaint;Landroid/text/TextDirectionHeuristic;II)V
    ...
    .line 3
    invoke-static {p1}, Landroid/support/v4/media/session/y;->h(Landroid/text/TextPaint;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 4
    invoke-static {v0, p3}, Landroid/support/v4/media/session/y;->f(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 5
    invoke-static {v0, p4}, Landroid/support/v4/media/session/y;->A(Landroid/text/PrecomputedText$Params$Builder;I)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 6
    invoke-static {v0, p2}, Landroid/support/v4/media/session/y;->g(Landroid/text/PrecomputedText$Params$Builder;Landroid/text/TextDirectionHeuristic;)Landroid/text/PrecomputedText$Params$Builder;

    move-result-object v0

    .line 7
    invoke-static {v0}, Landroid/support/v4/media/session/y;->i(Landroid/text/PrecomputedText$Params$Builder;)Landroid/text/PrecomputedText$Params;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/text/e;->e:Landroid/text/PrecomputedText$Params;
...
.method public final a(Landroidx/core/text/e;)Z
    ...
    iget v1, p1, Landroidx/core/text/e;->d:I
    ...
    iget-object v1, p1, Landroidx/core/text/e;->a:Landroid/text/TextPaint;
...
.method public final hashCode()I
    ...
    iget-object v9, p0, Landroidx/core/text/e;->b:Landroid/text/TextDirectionHeuristic;
