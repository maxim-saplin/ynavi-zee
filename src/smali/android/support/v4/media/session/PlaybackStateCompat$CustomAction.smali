...
.method public static b(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/g0;->l(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/g0;->f(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Landroid/support/v4/media/session/g0;->o(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;

    move-result-object v3

    invoke-static {p0}, Landroid/support/v4/media/session/g0;->m(Landroid/media/session/PlaybackState$CustomAction;)I
...
# virtual methods
.method public final d()Landroid/media/session/PlaybackState$CustomAction;
    .locals 3
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/g0;->e(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/media/session/PlaybackState$CustomAction$Builder;

    move-result-object v0

    iget-object v1, p0, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->e:Landroid/os/Bundle;

    invoke-static {v0, v1}, Landroid/support/v4/media/session/g0;->w(Landroid/media/session/PlaybackState$CustomAction$Builder;Landroid/os/Bundle;)V

    invoke-static {v0}, Landroid/support/v4/media/session/g0;->b(Landroid/media/session/PlaybackState$CustomAction$Builder;)Landroid/media/session/PlaybackState$CustomAction;
