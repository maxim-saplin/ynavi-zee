...
# static fields
.field public static final Companion:Lvu2/s;

.field private static final f:I = 0x8

.field private static final g:Ljava/lang/String; = "upload_tasks"
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lvu2/s;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lvu2/t;->Companion:Lvu2/s;

    return-void
.end method

.method public constructor <init>(Landroid/app/Application;Lz21/a;Lio/reactivex/d0;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lvu2/t;->a:Landroid/app/Application;

    iput-object p3, p0, Lvu2/t;->b:Lio/reactivex/d0;

    iput-object p4, p0, Lvu2/t;->c:Ljava/lang/String;

    const-string p3, "upload_tasks"
    ...
    iput-object p1, p0, Lvu2/t;->d:Landroid/content/SharedPreferences;

    new-instance p1, Lct2/a;

    const/16 p3, 0xa

    invoke-direct {p1, p2, p3}, Lct2/a;-><init>(Lz21/a;I)V

    invoke-static {p1}, Lcom/yandex/mapkit/maps/core/utils/FunctionsKt;->unsafeLazy(Lkotlin/jvm/functions/Function0;)Lm31/h;

    move-result-object p1

    iput-object p1, p0, Lvu2/t;->e:Lm31/h;

    return-void
.end method

.method public static a(Lvu2/t;Ljava/lang/String;Ljava/lang/String;)Lm31/d0;
    .locals 0

    iget-object p0, p0, Lvu2/t;->d:Landroid/content/SharedPreferences;
...
.method public static b(Lvu2/t;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Lm31/d0;
    .locals 0

    invoke-virtual {p0, p1}, Lvu2/t;->l(Landroid/net/Uri;)V
...
.method public static c(Lvu2/t;Ljava/lang/String;Ljava/lang/String;)Lm31/d0;
    .locals 0
...
.method public static d(Lvu2/t;)Ljava/util/List;
    .locals 10

    iget-object v0, p0, Lvu2/t;->d:Landroid/content/SharedPreferences;
    ...
    :cond_0
    iget-object v1, p0, Lvu2/t;->d:Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0, v3}, Lvu2/t;->i(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    check-cast v6, Lru/yandex/yandexmaps/photo_upload/api/TaskData;

    invoke-virtual {v6}, Lru/yandex/yandexmaps/photo_upload/api/TaskData;->getUri()Landroid/net/Uri;

    move-result-object v7

    invoke-virtual {p0, v7}, Lvu2/t;->g(Landroid/net/Uri;)Z
    ...
    :try_start_0
    iget-object v8, p0, Lvu2/t;->a:Landroid/app/Application;
    ...
    invoke-virtual {v6}, Lru/yandex/yandexmaps/photo_upload/api/TaskData;->getAutoRetries()I
    ...
    invoke-virtual {p0, v6}, Lvu2/t;->l(Landroid/net/Uri;)V
    ...
    :cond_6
    invoke-virtual {p0}, Lvu2/t;->h()Lcom/squareup/moshi/JsonAdapter;
...
.method public static e(Lvu2/t;Ljava/lang/String;Ljava/lang/String;)Lm31/d0;
    .locals 0
...
# virtual methods
.method public final f(Ljava/lang/String;Lru/yandex/yandexmaps/photo_upload/api/TaskData;)V
    .locals 5
    ...
    invoke-virtual {p0, v0}, Lvu2/t;->g(Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lvu2/t;->a:Landroid/app/Application;
    ...
    :cond_0
    new-instance v0, Lvu2/q;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lvu2/q;-><init>(I)V
    ...
    new-instance v1, Lvu2/r;

    const/4 v2, 0x1

    invoke-direct {v1, p0, p1, v2}, Lvu2/r;-><init>(Lvu2/t;Ljava/lang/String;I)V
    ...
    invoke-direct {v1, p1, v3}, Lru/yandex/yandexmaps/multiplatform/core/cache/a;-><init>(Ljava/lang/String;I)V

    new-instance v3, Lvh1/h;

    const/16 v4, 0x16

    invoke-direct {v3, v4, v1}, Lvh1/h;-><init>(ILkotlin/jvm/functions/Function1;)V
    ...
    iget-object v0, p0, Lvu2/t;->b:Lio/reactivex/d0;

    invoke-virtual {p2, v0}, Lio/reactivex/e0;->s(Lio/reactivex/d0;)Lio/reactivex/e0;

    move-result-object p2

    new-instance v0, Lvu2/r;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, Lvu2/r;-><init>(Lvu2/t;Ljava/lang/String;I)V
    ...
    new-instance p1, Lvh1/h;

    const/16 v2, 0x14

    invoke-direct {p1, v2, v0}, Lvh1/h;-><init>(ILkotlin/jvm/functions/Function1;)V
...
.method public final g(Landroid/net/Uri;)Z
    ...
    iget-object v0, p0, Lvu2/t;->c:Ljava/lang/String;
...
.method public final h()Lcom/squareup/moshi/JsonAdapter;
    ...
    iget-object v0, p0, Lvu2/t;->e:Lm31/h;
...
.method public final j(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-direct {p1, p2, v1}, Lvh1/h;-><init>(ILkotlin/jvm/functions/Function1;)V
...
.method public final k(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lvu2/t;->b:Lio/reactivex/d0;
...
.method public final l(Landroid/net/Uri;)V
    ...
    invoke-virtual {p0, p1}, Lvu2/t;->g(Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lvu2/t;->a:Landroid/app/Application;
...
.method public final m(Ljava/lang/String;Landroid/net/Uri;Lv23/f;)V
    .locals 7
    ...
    invoke-direct {v0, p1, p2, v2}, Ljb3/c;-><init>(Ljava/lang/String;Landroid/net/Uri;I)V

    new-instance p1, Lvh1/h;

    const/16 p2, 0x12

    invoke-direct {p1, p2, v0}, Lvh1/h;-><init>(ILkotlin/jvm/functions/Function1;)V
