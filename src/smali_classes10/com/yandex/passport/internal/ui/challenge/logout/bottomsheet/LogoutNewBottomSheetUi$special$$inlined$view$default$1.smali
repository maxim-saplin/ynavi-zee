.class public final synthetic Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;
...
# static fields
.field public static final b:Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;

    invoke-direct {v0}, Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;-><init>()V

    sput-object v0, Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;->b:Lcom/yandex/passport/internal/ui/challenge/logout/bottomsheet/LogoutNewBottomSheetUi$special$$inlined$view$default$1;
...
.method public final invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-class v9, Landroidx/appcompat/widget/AppCompatSeekBar;

    const-class v10, Landroid/widget/SeekBar;

    const-class v11, Landroidx/appcompat/widget/AppCompatRatingBar;

    const-class v12, Landroid/widget/RatingBar;

    const-class v13, Landroid/widget/MultiAutoCompleteTextView;

    const-class v14, Landroid/widget/AutoCompleteTextView;

    const-class v15, Landroid/widget/CheckedTextView;

    move-object/from16 p1, v3

    const-class v3, Landroidx/appcompat/widget/k0;
    ...
    const-class v5, Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    const-class v7, Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    const-class v10, Landroidx/appcompat/widget/AppCompatEditText;
    ...
    const-class v12, Landroidx/appcompat/widget/AppCompatImageView;
    ...
    const-class v15, Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatTextView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatImageView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatEditText;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatImageButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatCheckBox;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/k0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatRatingBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/AppCompatSeekBar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/recyclerview/widget/RecyclerView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Landroidx/appcompat/widget/Toolbar;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Lcom/google/android/material/floatingactionbutton/FloatingActionButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v2, v0, v5, v1}, Lo8/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
